        ...
        <div class="span9">
          <div class="row space60"></div>
             <nav id="nav" role="navigation">
                ...
                <li><a href="find.php" title="">Find Mates</a></li>
               <li class="active"><a href="contact.php" title="">Contact</a></li>
               <li><a href="apply.php" title="">Apply</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="span3 offset3">
          ...
          Indonesia<br>
          <br>
          <i class="icon-phone"></i>+812 880 555 999<br>
          <i class="icon-envelope"></i>temanberkarya@gmail.com<br>
          <!--
          <div class="row space40"></div>  
